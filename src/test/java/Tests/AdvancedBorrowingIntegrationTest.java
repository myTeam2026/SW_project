...
public class AdvancedBorrowingIntegrationTest {
    ...
    public void testCompleteBorrowingRestrictionsScenario() {
        // Test 1: استعارة 3 كتب (الحد الأقصى)
        ...
        // Test 4: إضافة غرامة وإزالة الكتاب المتأخر أولاً
        ...
        // Test 5: التحقق من عدم إمكانية إلغاء التسجيل
